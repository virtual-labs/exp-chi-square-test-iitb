function activity2_p3() {
    ...
    btn && btn.remove();
    let btn_txt = get_collapse_btn_text('Selecting alpha value', 'act2-p3-div');
    maindiv.innerHTML += `
      ${btn_txt}
      ...
      <div>
         ...
         <div class='fs-22px fb-600 center-text'>
            ...
            <br>
            <br>
            <button class='btn btn-info std-btn' style='margin: auto;' id='act2-p3-btn-2' onclick='activity2_p4()' >Next</button>
         </div>
...
// 		document.getElementById('act2-p3-btn-1')
// 	);
// 	let next_btn: HTMLDivElement = <HTMLDivElement>(
// 		document.getElementById('act2-p3-btn-2')
// 	);
// 	if (inp.value != '0') {
// 		alpha = parseFloat(inp.value);
// 		let s_2: HTMLDivElement = <HTMLDivElement>(
// 			document.getElementById('act2-p3-alpha-div')
// 		);
...
// 		chi_sq_alpha_a2 = chi_sq_table_data[indx][alpha_indx];
// 		console.log(indx, alpha_indx);
// 		console.log('chi', chi_sq_alpha_a2);
// 	} else {
